...
<script>
	$(document).ready(function(){
		...
		$("#memberId").click(function(){
			console.log(document.memberForm.memberId.value);
			window.name = "parentForm";
			window.open("${pageContext.request.contextPath}/memberIdCheckForm"
...
<body>
	...
	<div id="containerMember" class="col-md-6 col-md-offset-3">
		<h1>addMember</h1>
		<form id="memberForm" name="memberForm" action="${pageContext.request.contextPath}/addMember" method="post">
			...
			<div class="form-group member-pw-check">
				...
				<div class="input-group">
					<span class="input-group-addon"></span>
					<input type="password" class="form-control" id="memberPwCheck" name="memberPwCheck" placeholder="비밀번호 확인" value="${member.memberPwCheck}">
				</div>
				<p>비밀번호가 일치하지 않습니다</p>
			</div>
			<div class="progress">
			...
			<div class="form-group text-center">
				<button type="button" id="memberBtn" class="btn btn-info">회원가입</button>
