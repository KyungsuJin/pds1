	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="${pageContext.request.contextPath}/getOrderList?memberNo=${sessionMemberNo}" data-toggle="tooltip" data-placement="bottom"
					title="orderList">getOrderList</a></li>
